...
2. **Face Detection**: Processes frames using OpenCV to detect faces in real-time.
3. **Face Recognition**: Applies a pre-trained deep learning model to identify individuals.
4. **Attendance Logging**: Records recognized faces with timestamps in the database.
5. **User Interface**: Displays real-time attendance status and provides administrative controls.
