...
# System Architecture Diagram: Real-Time Face Attendance System
...
- **Utility Components (Gray)**: Additional components for logging and operational tracking.
...
- **OpenCV Processing**: Refines and processes frames for further analysis (e.g., converting to grayscale, resizing).
...
- **Database**: Stores face data, attendance logs, and metadata.
...
2. **Face Detection Pipeline**: 
   ...
   - **OpenCV Processing** enhances the detected frames for accuracy.
3. **Recognition & Training**:
...
<img width="666" alt="image" src="https://github.com/user-attachments/assets/3e8b61d6-9076-46c3-8efd-466b489ff8bd" />
